...
function fnValidarUsuarios() {
    ...
    if (SBN_SESSION == false) {
        ...
        var rutaVistaCertificados = 'fnhrefpagina("../Vista/ViewCertificados.html")';
        ...
        btnlogins += "<a class='dropdown-item' onclick='" + rutaVistaCertificados + "'><i class='fa fa-fw fa-certificate'></i>&nbsp; Certificados</a>";
...
function fnDetalleCurso(idcurso, nombrecurso, imagen, nomCortoCurso) {

    sessionStorage.setItem("sesidcurso", idcurso);
    sessionStorage.setItem("sesnombrecurso", nombrecurso);
    sessionStorage.setItem("sesnombreCortocurso", nomCortoCurso);
...
function hrefmatricula() {
    ...
    sessionStorage.setItem("sesUSUARIO", SBN_USER);
    if (SBN_USER == null) {
...
function fnhrefpagina(ruta) {
    ...
    if (ruta == "../Vista/ViewCronograma.html" || ruta == "../Vista/ViewMatricula.html" || ruta == "../Vista/contactenos.html" || ruta == "../Vista/ViewPreguntasFrec.html" || ruta == "../Vista/ViewCertificados.html") {
