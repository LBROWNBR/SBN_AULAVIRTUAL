        ...
        if ($message[0] != 'FAILED') {
            ...
            try {
                ...
                */
                ...
                $messageEmail.="<tablewidth='100%'bgcolor='#e0e0e0'cellpadding='0'cellspacing='0'border='0'>";
                $messageEmail.="<tr><td>";
                $messageEmail.="<br>";
                $messageEmail.="<tablealign='center'width='100%'border='0'cellpadding='0'cellspacing='0'style='max-width:60%;background-color:#fff;font-family:Verdana,Geneva,sans-serif;'>";
                $messageEmail.="<thead>";
                $messageEmail.="<tr>";
                $messageEmail.="<thcolspan='4'>";
                $messageEmail.='<divstyle="text-align:center;padding:30px;"><imgwidth="450"src="https://www.sbn.gob.pe/Repositorio/Portal/logoweb_350x50.png"alt="Logo"></div>';
                $messageEmail.="</th>";
                $messageEmail.="</tr>";
                $messageEmail.="</thead>";
                $messageEmail.="<tbody>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.='<divstyle="text-align:center;padding:15px;background-color:#E53935;font-weight:bold;color:#fff;font-size:20px;">PlataformaVirtualdelaSBN</div>';
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:20px;text-align:center;color:#1f5278;'><h1>¡Bienvenido(a)Sr(a)Docente!</h1></div>";
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:0px25px0px25px;text-align:justify;font-size:19px;color:#1f5278;'><p>Estimado(a)".$nombres.",ustedhasidoinscritocomodocenteenelcursode<strong>".$cursoNameLarge."</strong><strong>(".$cursoNameSmall.")</strong>denuestraaulavirtualdelaSBN.</p></div>";
                $messageEmail.="</td>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:0px25px20px25px;text-align:justify;font-size:19px;color:#1f5278;'><p>Sucuentadeingresoes:</p></div>";
                $messageEmail.="</td>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<table>";
                $messageEmail.="<tr>";
                $messageEmail.='<td><divstyle="background-color:#184E74;margin:030px080px;padding:10px50px10px50px;text-align:left;border-radius:50px;color:#ffffff;">USUARIO:'.$user.'</div></td>';
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.='<td><br></td>';
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.='<td><divstyle="background-color:#184E74;margin:030px080px;padding:10px50px10px50px;text-align:left;border-radius:50px;color:#ffffff;">CONTRASE&Ntilde;A:'.$pass.'</div></td>';
                $messageEmail.="</tr>";
                $messageEmail.="</table>";
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:25px;text-align:justify;font-size:19px;color:#1f5278;'><p>Yapuedesiniciarsesiónen:<ahref='https://aulavirtual.sbn.gob.pe/sdnc/login/iniciar-sesion.php'>https://aulavirtual.sbn.gob.pe/sdnc/login/iniciar-sesion.php</a></p></div>";
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:00025px;text-align:justify;font-size:19px;color:#1f5278;'><p>Saludoscordiales,</p></div>";
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.="<divstyle='padding:00025px;text-align:justify;font-size:19px;color:#1f5278;'><p>SubdireccióndeNormasyCapacitación<br>CalleChinchon890,SanIsidro<br>Teléfono:317-4400<br></p></div>";
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="<tr>";
                $messageEmail.="<tdcolspan='4'>";
                $messageEmail.='<divstyle="text-align:center;padding:15px;background-color:#E53935;font-weight:bold;color:#fff;font-size:20px;">&nbsp;</div>';
                $messageEmail.="</td>";
                $messageEmail.="</tr>";
                $messageEmail.="</tbody>";
                $messageEmail.="</table>";
