...
BEGIN
		...
		IF (V_TOT_INSCRITO_CURSO_NOM_ANIO >= p_maximoReg )THEN
            ...
            SELECT CONCAT('Usted ya participó en ', p_maximoReg, ' o más cursos en el presente año.', ' Para cualquier consulta al respecto de los cursos de capacitación puede escribirnos al correo de capacitacion@sbn.gob.pe') INTO msg_salida;
