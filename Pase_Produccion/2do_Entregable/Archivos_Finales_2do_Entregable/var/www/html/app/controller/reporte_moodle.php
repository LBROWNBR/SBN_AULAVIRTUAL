    ...
    case 'reporte_alumnos_inscritos':
        ...
        foreach ($dataCURS as $curso) {
            ...
            $listaAlumCursos[] = [
                ...
                29 => html_utf8($dataPREMATRICULAALUMNO[0]['mat_horalectiva']),      // mat_horalectiva
                30 => html_utf8($dataPREMATRICULAALUMNO[0]['NotaPractica']),      // NotaPractica
                31 => html_utf8($dataPREMATRICULAALUMNO[0]['NotaForo']),      // NotaForo
                32 => html_utf8($dataPREMATRICULAALUMNO[0]['ExamenFinal']),      // ExamenFinal
                33 => html_utf8($dataPREMATRICULAALUMNO[0]['PromedioFinal']),      // PromedioFinal
                34 => html_utf8($dataPREMATRICULAALUMNO[0]['mat_codpoi']),      // mat_codpoi
                35 => html_utf8($ConCertificado),      // ConCertificado
                36 => html_utf8($dataPREMATRICULAALUMNO[0]['NroCertificado']),      // NroCertificado
            ];
        }
